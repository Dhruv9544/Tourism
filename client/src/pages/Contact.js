  ...
  return (
    <Fragment>
      ...
      <div className="container mx-auto">
        <div className="bg-white p-2">
          <div className="flex justify-between items-center font-semibold text-lg text-black">
            <div className=" p-2 rounded-lg w-1/2 text-center border-b-2 border-orange-700">
              About
            </div>
            <div className=" p-2 rounded-lg w-1/2 text-center">Map</div>
          </div>
        </div>
        <div className="p-2">
        ...
        <div className="text-center  font-sans  container mx-auto">
          ...
          <div className="flex mb-4 p-5">
            <img
              ...
              alt="John Doe"
              className="w-16 h-16 mr-4 bg-orange-100"
            />
            <div>
              <p className="text-lg font-semibold text-start">By Road</p>
          ...
          <div className="flex mb-4 p-5">
            <img
              src="https://static.vecteezy.com/system/resources/previews/020/211/376/non_2x/bus-icon-free-vector.jpg"
              alt="John Doe"
              className="w-16 h-16 mr-4 bg-orange-200"
            />
            <div>
              <p className="text-lg font-semibold text-start">By Train</p>
              <p className="text-gray-600">
          ...
          <div className="flex mb-4 p-5">
            ...
            />
            <div>
              <p className="text-lg font-semibold text-start">By Air</p>
              <p className="text-gray-600">
      ...
      <div className="container mx-auto flex flex-col items-center justify-center mb-5 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 gap-y-10 gap-x-10 ">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold mb-2">Drawing</h2>
              <p className="text-gray-600">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
                auctor eros sit amet turpis lacinia, id ullamcorper libero
                sodales.
